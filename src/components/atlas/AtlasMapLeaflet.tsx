...
// Waypoints Data — all 28 Atlas waypoints
const waypoints = [
  // EMBER TERRITORY
...
function MapController({ selectedWaypoint }: { selectedWaypoint: typeof waypoints[0] | null }) {
  const map = useMap();
...
export function AtlasMapLeaflet() {
    ...
    <div className="w-full h-full relative font-serif text-[#F5F0EB] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-[#1a1714]">
        ...
        >
          ...
          <MapController selectedWaypoint={selectedWaypoint} />
        ...
        {selectedWaypoint && (
          ...
          >
            <div className="p-8 flex-1 overflow-y-auto">
              ...
              <p className="font-serif text-lg leading-relaxed text-[#F5F0EB]/90 mb-10">
              ...
              {process.env.NEXT_PUBLIC_GEMINI_API_KEY && (
                <div className="bg-[#C4A265]/5 border border-[#C4A265]/20 rounded p-5 relative overflow-hidden">
                  ...
                  {!geminiResponse && !isLoadingGemini && (
                    <div>
                      <p className="font-serif text-sm text-[#F5F0EB]/70 mb-4">
                  ...
                  {isLoadingGemini && (
                    <div className="flex items-center gap-3 text-[#C4A265]/70 py-4">
                      ...
                      <span className="font-serif text-sm">Consulting the archives...</span>
                    </div>
                  )}
