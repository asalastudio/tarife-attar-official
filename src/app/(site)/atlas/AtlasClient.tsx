...
export function AtlasClient({ territories, totalCount, placeholderImages }: Props) {
  ...
  return (
    <div className="min-h-screen bg-theme-alabaster text-theme-charcoal overflow-x-hidden">
      ...
      <section className="pt-8 md:pt-14 pb-4 md:pb-8 px-4 md:px-24">
                    ...
                    >
                      <div className="relative aspect-square flex items-center justify-center px-6">
                        <div className="text-center space-y-4">
                          <Compass weight="thin" className="w-8 h-8 mx-auto opacity-20 group-hover:opacity-40 transition-opacity" />
