...
FORMAT: All Atlas waypoints are concentrated perfume oil, alcohol-free, glass wand applicator. Available in 3ml ($23), 6ml and 12ml. Every waypoint has a 3ml travel size, but stock varies by waypoint and size, so send customers to the product page to see which sizes are available. Through 28 September any three 3ml bottles are $50 together, applied automatically at checkout with no code.
