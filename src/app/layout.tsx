...
export const metadata: Metadata = {
    ...
    description: 'Artisanal perfume oils and rare attars. Alcohol-free, skin-safe, cruelty-free. 28 fragrances across four olfactory territories. Oud, musk, amber, rose, jasmine, and marine compositions in concentrated roll-on oil format.',
    keywords: ['perfume oil', 'attar', 'oud perfume oil', 'niche fragrance', 'roll on perfume', 'alcohol free perfume', 'skin safe fragrance', 'cruelty free perfume oil', 'artisanal fragrance', 'musk perfume oil', 'amber perfume oil', 'rose perfume oil'],
